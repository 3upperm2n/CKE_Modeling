...
#print ''
#print 'leiming: cudastreams ' + str(len(streams_lnch_ovhd) + 1)

#print 'min\tmax\tavg\t(ms)'
print str(min(streams_lnch_ovhd)) + ',' + str(max(streams_lnch_ovhd)) + ',' + str(sum(streams_lnch_ovhd) / float(len(streams_lnch_ovhd))) 
